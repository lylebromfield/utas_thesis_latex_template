...
- `thesis.tex` currently includes chapters/chapter1/chapter1, chapters/chapter2/chapter2, appendices/app0/app0, components/biby, and components/index; add more includes as you create chapters/appendices, and use `\\includeonly{...}` to speed compilation during drafting.
